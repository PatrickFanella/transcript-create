...
For local services, copy `.env.example`, then run `docker compose up --build`. The frontend defaults to `http://localhost:5173`; the API defaults to `http://localhost:8000`.
